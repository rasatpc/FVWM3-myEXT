...
yad --paned --key=$key --title="Extension Installer" \
    --button=Close:1 --button='Reset:bash -c "./reset.sh"' --button='Update myExt:bash -c "./update.sh"' --button=Install:0 --center --orient=Horizontal --splitter=620 --width=800 --height=630
exec 3>&-
